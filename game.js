var GAME = (function () {
	...
	exports.Game = function (input, ctx) {
		...
		states.base = new function () {
			...
			states.title.__proto__ = that;
			
			states.main = new function () {
				var that = this;
				...
				states.serving.__proto__ = that;
				
				states.playing = new function () {
					var that = this;
					
					that.onEnter = ENGINE.noop;
				};
				states.playing.__proto__ = that;
			};
			states.main.__proto__ = that;
		};
